var textSet = {
    ...
    "english": {
        "PostMessage": "User [t_node.name] broadcasts a new message.",
        "InfluenceDiscription": "A users's giving method is updated to become more similar, on average, to those reflected in agreeable broadcasts from neighbors. The influence controls how fast this happens.",
        "InfoRepresentQ": "What does the network represent?",
        "InfoInstructionsQ": "What do I do?",
        "Title": "Avalanche Protocol",
        "Stop": "Stop",
        "InfoTitle": "Avalanche Protocol: FAQ",
        "Conservative": "Volunteer",
        "Start": "Start",
        "Theme": "a Paradigm Shift in Fundraising",
        "InfoHowQ": "How does it work?",
        "Scenario04Discription": "When users are influenced by their friends with similar values and can unfollow those with different values, the network quickly converges into two or more giving types. The number depends on the tolerance, as long as it is not too high: the smaller the tolerance, the more giving types.",
        "Low": "Low",
        "BecomeLessProgressice": "User [t_node.name] less likely to donate",
        "Scenario01Discription": "Without influence and unfollowing, users are exposed to diverse values but their own values do not change, and the underlying network structure stays the same.",
        "RepostMessage": "User [t_node.name] reposts user [repost_node.name]'s virtue.",
        "Tolerance": "Tolerance",
        "TranslatersName": " ",
        "Medium": "Medium",
        "Scenario": "Scenario",
        "ReadMessage": "User [t_node.name] reads [concordant_nodes.length] virtues.",
        "Never": "Never",
        "Weak": "Weak",
        "InfoInstructionsA": "Initially, users have different values and are connected in a random network. Test different user value ranges (or pick one of the generational profiles), run the avalanche protocol, and observe what happens.",
        "Reset": "Reset",
        "Strong": "Strong",
        "Unfriending": "unfollow",
        "Scenario02Discription": "Without the ability to unfollow, the network structure remains unchanged and users are exposed to diverse values. However, influence causes users' values to change based on frequency of exposure/engagement. Depending on the users pre-established more compass and their tolerance of disagreeable values, the network converges either to a homogeneous state where all (or almost all) users have a similiar method of giving, or to a state where two (or more) methods of giving may coexist.",
        "Off": "Off",
        "InfoIntroQ": "What is Avalanche?",
        "Language": "English",
        "Default": "Default",
        "Sometimes": "Sometimes",
        "MorePopular": "More Likely",
        "Scenario05Discription": "With high tolerance, unfollowing has small effect. Influence causes the system to quickly converge to a single group with similiar values.",
        "Time": "Time",
        ...
        "GraphDiscription": "This plot tracks how a users preferred method of giving is clearly defined overtime.",
        "UnfriendingDiscription": "This parameter regulates how often a user will unfollow an organization who broadcasts a disagreeable value, and replace it with an organization with a higher value match.",
        "InfoRepresentA": "Each node in the network represents an organization; its size represents its popularity (number of followers) and its color represents the preferred method of giving by followers",
        "AdvancedParameters": "Advanced Parameters",
        "Often": "Often",
        "Progressive": "Donor",
        "GraphTitle": "Giving Method",
        "Unfollow": "User [t_node.name] unfollows user [del_node.name], follows user[add_node.name].",
        "Influence": "Influence",
        "BecomeMoreConservative": "User [t_node.name] more likely to volunteer",
        "BecomeMoreProgressice": "User [t_node.name] more likely to donate",
        "High": "High",
        "ToleranceDiscription": "Tolerance defines how a user interacts with different values. Messages reflecting values within this range from a user's own moral compass are considered as agreeable, otherwise as disagreeable. Broadcasts can influence a user’s own values (positive/negative). Users will occasionally unfollow organizations who post disagreeable messages.",
        "InfoHowA": "Users do four things: (1) they read broadcasts posted/re-posted by their\nfriends; (2) their values will slightly change (based on the influence\nparameter) according to agreeable messages (based on the tolerance\nparameter); (3) once in a while (based on the unfollow parameter)\nthey replace a user who posts messages sufficiently different from\ntheir own values (based on the tolerance parameter) with a random\nfriend; and (4) they either post a new message reflecting their\nvirtue, or re-post a agreeable message (based on the tolerance\nparameter) from another friend.",
        "BecomeLessConservative": "User [t_node.name] less likely to volunteer",
        "ParameterSetting": "Parameter Setting",
        "Speed": "Speed",
        "LessPopular": "Less Likely",
        "InfoIntroA": "Avalanche leverages the power of social networks --- influencing other users within their commmunity that hold different values."
    }
}